...
static const SLRTableEntry SLR_TABLE[] =
        {
                ...
                {{{T_ID,      SHIFT,     26},             {T_LITERAL, SHIFT,  22},           {T_CHARACTER, SHIFT,  23},           {T_BOOLSTR, SHIFT,  24},           {T_L_PAREN, SHIFT,  25},           {T_NUM,    SHIFT,  27}},                                                                                {{NT_RHS,     20}, {NT_EXPR, 21}}},
                ...
                {{{T_SEMI,    REDUCE,    NT_EXPR,     3}, {T_ADDSUB,  REDUCE, NT_EXPR,   3}, {T_MULTDIV,   REDUCE, NT_EXPR,   3}, {T_R_PAREN, REDUCE, NT_EXPR,   3}},                                                                                                                                           {}},
                {{{T_SEMI,    REDUCE,    NT_EXPR,     4}, {T_ADDSUB,  REDUCE, NT_EXPR,   4}, {T_MULTDIV,   REDUCE, NT_EXPR,   4}, {T_R_PAREN, REDUCE, NT_EXPR,   4}},                                                                                                                                           {}},
                {{{T_R_BRACE, SHIFT,     36}},                                                                                                                                                                                                                                                                  {}},
                ...
                {{{T_R_PAREN, REDUCE,    NT_COND,     0}, {T_COMP,    SHIFT,  70}},                                                                                                                                                                                                                             {}}, // Ambiguous
                ...
                {{{T_L_BRACE, SHIFT,     81}},                                                                                                                                                                                                                                                                  {}},
                {{{T_VTYPE,   SHIFT,     51},             {T_ID,      SHIFT,  52},           {T_R_BRACE,   REDUCE, NT_BLOCK,  1}, {T_IF,      SHIFT,  49},           {T_WHILE,   SHIFT,  50},           {T_RETURN, REDUCE, NT_BLOCK,  1}},                                                                      {{NT_V_DECL,   47}, {NT_ASSIGN, 48}, {NT_BLOCK, 82}, {NT_STMT, 46}}},
                {{{T_R_BRACE, SHIFT,     83}},                                                                                                                                                                                                                                                                  {}},
