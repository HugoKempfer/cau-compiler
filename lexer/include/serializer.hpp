...
static const std::unordered_map<TokenType, std::string> TokenNames = {
    {BOOL, "BOOL"},           {KEYWORD, "KEYWORD"},
    {ITERATIVE, "ITERATIVE"}, {CONDITIONAL, "CONDITIONAL"},
    {ARTITH_OP, "ARTITH_OP"}, {ASSIGN, "ASSIGN"},
    {CMP_OP, "CMP_OP"},       {SC, "SC"},
    {BLOCK, "BLOCK"},         {PAREN, "PAREN"},
    {ARRAY, "ARRAY"},         {COMMA, "COMMA"},
    {V_TYPE, "V_TYPE"},       {ID, "ID"},
    {LITERAL, "LITERAL"},     {S_INT, "S_INT"},
    {S_CHAR, "S_CHAR"},       {WHITESPACE, "WHITESPACE"}};
